...
class Organisation(Base):
    ...
    industry_type: Mapped[Industry] = mapped_column(Enum(Industry, name='industry', create_constraint=False), default=Industry.DEFAULT, nullable=False, server_default='default')
    subscription_plan: Mapped[SubscriptionPlan] = mapped_column(Enum(SubscriptionPlan, name='subscriptionplan', create_constraint=False), default=SubscriptionPlan.basic, server_default=SubscriptionPlan.basic.value)
