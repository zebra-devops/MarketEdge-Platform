...
-- Generated: 2025-09-23T11:23:40.685831
...
UPDATE alembic_version SET version_num = '003_phase3_enhancements' WHERE version_num IS NOT NULL;

-- If no version exists, insert it
INSERT INTO alembic_version (version_num) SELECT '003_phase3_enhancements' WHERE NOT EXISTS (SELECT 1 FROM alembic_version);
